...
ActiveRecord::Schema.define(:version => 20140423082231) do
  ...
  create_table "contractassets", :force => true do |t|
    t.string   "data_file_name"
    t.string   "data_content_type"
    t.decimal  "data_file_size",        :precision => 10, :scale => 0
    t.datetime "data_updated_at"
    t.decimal  "contract_id",           :precision => 10, :scale => 0
    t.datetime "created_at",                                           :null => false
    t.datetime "updated_at",                                           :null => false
  ...
  create_table "devicephotos", :force => true do |t|
    t.string   "data_content_type"
    t.string   "data_file_name"
  ...
  create_table "drilltowers", :force => true do |t|
    ...
    t.integer  "attachment_id"
    t.date     "discarddate"
    t.string   "discardtype"
    t.string   "discardreason"
    t.string   "officialcode"
  end
  ...
  create_table "holeassets", :force => true do |t|
    t.string   "data_content_type"
    t.string   "data_file_name"
    t.decimal  "data_file_size",        :precision => 10, :scale => 0
    t.datetime "data_updated_at"
    t.decimal  "hole_id",               :precision => 10, :scale => 0
    t.string   "data_origin_file_name"
    t.datetime "created_at",                                           :null => false
    t.datetime "updated_at",                                           :null => false
  end
  ...
  create_table "holes", :force => true do |t|
    ...
    t.string  "remark"
    t.integer "attachment_id"
    t.integer "opennoticeatt_id"
    t.integer "closenoticeatt_id"
    t.integer "curvetableatt_id"
    t.integer "measuretableatt_id"
    t.integer "coretransferdoc_id"
    t.integer "tourreporttransferdoc_id"
    t.integer "qualitychecktable_id"
    t.integer "tourreporttabledoc_id"
    t.string  "designminecoreratio"
    t.string  "actualminecoreratio"
    t.string  "designpositionangle"
    t.string  "actualpositionangle"
  ...
  create_table "materials", :force => true do |t|
    ...
    t.string   "manufacture"
    t.integer  "holeid"
    t.decimal  "stockin",      :precision => 10, :scale => 0
    t.string   "recipient"
  end
  ...
  create_table "tourreports", :force => true do |t|
    ...
    t.decimal  "source",             :precision => 10, :scale => 0
  end
